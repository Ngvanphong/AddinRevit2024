...
{
    internal class SplitButtonCustom
    {
        public void Split(UIControlledApplication application)
        {
            try
            {
            ...
            ImageSource imageResourceLarge = Extension.GetImageSource(Resources.icons8_crop_24__1_);
            SplitButtonData splitButtonData = new SplitButtonData("StructuralCreating", "Create");
            splitButtonData.LargeImage = imageResourceLarge;
            splitButtonData.ToolTip = "Tool tip";
            splitButtonData.LongDescription = "Description";
